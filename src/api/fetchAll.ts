...
export const fetchCart = async (id: number): Promise<FetchUserAllModel> => {
	...
	const res = await fetch(`http://192.168.59.63:3000/carts/${id}`, {
		headers: {
...
export const fetchChatHistoryAll = async (): Promise<FetchUserAllModel> => {
	...
	const res = await fetch(`http://192.168.59.63:3000/chatroomHistorys/`);
	if (res.ok) {
		const data = await res.json();
		console.log(data);
		return data;
...
export const fetchTeacher = async (id: number): Promise<FetchUserAllModel> => {
	...
	const res = await fetch(`http://192.168.59.63:3000/teachers/${id}`);
...
export const fetchTeacherAll = async (): Promise<FetchUserAllModel> => {
	...
	const res = await fetch(`http://192.168.59.63:3000/teachers`);
...
// 	const res = await fetch('http://192.168.59.63:3000/cartDetails/', {
// 		method: 'POST',
// 		headers: {
...
export const fetchDeleteUser = async (id: number): Promise<FetchUserAllModel> => {
	...
	const res = await fetch(`http://192.168.59.63:3000/users/${id}`, {
		method: 'DELETE',
		headers: {
			'Content-Type': 'application/json'
		},
...
export const fetchDropFromCart = async (id: number): Promise<FetchUserAllModel> => {
	...
	const res = await fetch(`http://192.168.59.63:3000/cartDetails/${id}`, {
		method: 'Delete',
		headers: {
			'Content-Type': 'application/json'
		},
...
export const fetchCourse = async (): Promise<FetchUserAllModel> => {
	...
	const res = await fetch(`http://192.168.59.63:3000/products/Course`);
...
export const fetchNote = async (): Promise<FetchUserAllModel> => {
	...
	const res = await fetch(`http://192.168.59.63:3000/products/Note`);
...
export const fetchProduct = async (id: number): Promise<FetchUserAllModel> => {
	...
	const res = await fetch(`http://192.168.59.63:3000/products/${id}`);
...
export const fetchFile = async (file: File): Promise<FetchUserAllModel> => {
	...
	const res = await fetch(`http://192.168.59.63:3000/users/file`, {
		method: 'POST',
		headers: {
